...
Write-Host "Frontend: http://localhost:5173 (or 8080, 8081)" -ForegroundColor Cyan
Write-Host ""
Write-Host "Both services are running in background jobs." -ForegroundColor Yellow
